...
ui <- fluidPage(
  ...
  page_navbar(
    ...
    nav_panel(title = "Welcome",
              ...
              p(""),
              tags$span(style = "color:black; font-size:13pt", "This webpage was created to provide you with the results from analyses of how proteins are related to metabolites."),
              ...
              tags$span(style = "color:black; font-size:13pt", "You can also see heatmap plots for any of these association in the ", tags$i("Observational analyses"),  " tab inside the ", tags$i("Heatmaps"), " tab at the top of this page. Models adjusted by age, sex, BMI and kidney function (eGFR) are display."),
              ...
              tags$span(style = "color:black; font-size:13pt", "We have also analyzed how 1,319 proteins were related to each of 790 non-xenobiotic metabolites in the POEM study. Since these relationships were not validated in an external cohort, these results are only available as a table to download."),
              p(""),
              tags$span(style = "color:black; font-size:13pt", tags$b("Abstract")),
              p(""),
              tags$span(style = "color:black; font-size:13pt", tags$b("Objective:"), "The genetic code is translated into protein synthesis. Many of these proteins will also affect intermediary metabolites by acting as enzymes, hormones or other actions. The aim of the present study was to evaluate how proteins are related to non-xenobiotic metabolites."),
              tags$span(style = "color:black; font-size:13pt", tags$b("Methods:") , "Protein levels were measured by proximity extension (PEA) and metabolites by mass spectrometry. Using genetic instruments for XX protein levels identified in UK biobank, Mendelian randomization (MR) was used to explore the relationships vs 790 metabolite levels using own genetic studies in two cohorts (SCAPIS and EpiHealth). The relationships found to be of interest in MR was also evaluated in the observational setting in the POEM study. Furthermore, pairwise relationships between levels of up to 1319 proteins and 790 metabolites were evaluated in three different ways in the EpiHealth, PIVUS and POEM studies."),
              tags$span(style = "color:black; font-size:13pt", tags$b("Results:"), "In the MR analysis, 1,073 (YY%) of the evaluated pairwise relationships were significant. 326 of the proteins were related to at least one of the metabolites. In a parallel observational analysis, only 25% of these relationships were significant, and the R2 for the relationship between the MR and observational estimates was only 0.05. In the three observational evaluations, 15-35% of the evaluated pairwise relationships were significant."),
              tags$span(style = "color:black; font-size:13pt", tags$b("Conclusion:"), "This study provides a comprehensive view of a great number of protein/ metabolite relationship using both MR and observational data and disclosed that observational studies are likely to grossly overestimate causal protein/metabolite relationships. Examples are given on the use of protein/metabolite relationships in clinical epidemiology."),
              p(""),
              p(""),
              p(""),
    ...
    nav_panel(title = "Tables",
              tabsetPanel(
                ...
                tabPanel(title = "Observational analyses",
                         ...
                         tags$span(style = "color:black; font-size:13pt", "Also, if you cannot open the menus below, please wait, it could take up to 45 seconds for them to show.") ,
                         p(""),
                         p(""),
                         p(""),
    ...
    nav_panel(title = "Heatmaps",
              tabsetPanel(
                ...
                tabPanel(title = "Observational analyses",
                         ...
                         p(""),
                         p(""),
                         tags$span(style = "color:black; font-size:13pt", "Please select a super- or sub-pathway, and one or several proteins and click", tags$i("Plot!."), "If you cannot open the menus below, please wait, it could take up to 45 seconds for them to show.") ,
                         tags$span(style = "color:black; font-size:13pt", "Also, if you cannot open the menus below, please wait, it could take up to 45 seconds for them to show.") ,
                         tags$span(style = "color:black; font-size:13pt", "Nominal p-value <0.01 = **; <0.05 = *; >=0.05 = no starts.") ,
                         p(""),
                         p(""),
                         p(""),
