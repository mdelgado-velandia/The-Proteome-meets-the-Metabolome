    ...
    nav_panel(title = "Heatmaps",
              tabsetPanel(
                ...
                tabPanel(title = "Observational analyses",
                         ...
                         p(""),
                         p(""),
                         tags$span(style = "color:black; font-size:13pt", "Please select a super- or sub-pathway, and one or several proteins and click", tags$i("Plot!."), "Nominal p-value <0.01 = 🞰🞰; <0.05 = 🞰; ≥0.05 = no stars. Model adjusted for age, sex, BMI and kidney function (eGFR)" ) ,
                         tags$span(style = "color:black; font-size:13pt", "Also, if you cannot open the dropdown menu below, please wait, it could take up to 45 seconds for them to show.") ,
                         p(""),
                         p(""),
                         p(""),
                ...
                tabPanel(title = "Mendelian Randomization",
                         ...
                         p(""),
                         p(""),
                         tags$span(style = "color:black; font-size:13pt", "Please select a super- or sub-pathway, and one or several proteins and click", tags$i("Plot!."), "Nominal p-value <0.01 = 🞰🞰; <0.05 = 🞰; ≥0.05 = no stars." ) ,
                         tags$span(style = "color:black; font-size:13pt", "Also, if you cannot open the dropdown menu below, please wait, it could take up to 45 seconds for them to show.") ,
                         p(""),
                         p(""),
                         p(""),
